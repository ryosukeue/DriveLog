...
struct ProcessingConfigurationTests {
    ...
    func locationAndSegmentation() {
        ...
        #expect(configuration.segmentation.softContinuousGap == 900)
        #expect(configuration.segmentation.absoluteMaximumContinuousGap == 5400)
        #expect(configuration.segmentation.minimumBridgeDistance == 100)
        #expect(configuration.segmentation.minimumBridgeAverageSpeed == 0.5 / 3.6)
        #expect(configuration.segmentation.maximumBridgeAverageSpeed == 250 / 3.6)
